<div class="navigation" id="navigation">
    <ul>
        <li><button type="button" class="btnShowPage" data-showThisPage="pageUser" id="btnLogedInUser">Home</button></li>
        <li><button type="button" class="btnShowPage" data-showThisPage="pageAllUsers" id="btnLogedInAllUsers">Overview</button></li>
