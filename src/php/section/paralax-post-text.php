<!-- <section id="trigger-text" class="paralax">

  <div id="pin-text" class="item left">
    <p id="post-logo" class="screen screenT1"></p>
  </div>
  ...
  <div class="item right">
    <div id="about-us" class="innerText innerT1">
      ...
      <p>
          ...
          software like Aldus PageMaker including versions of Lorem Ipsum.<br><br>It is a long established fact that a reader will be distracted by the readable content of a page when looking at 
          its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like 
          readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites 
    ...
    <div id="tasks-tools" class="innerText innerT4">
      ...
      <ul>
        ...
        <li>Maintenance of the reimplementation as well as other front-end web development tasks.</li>
        <li>Existing system maintenance, updates, improvements, etc.</li>
        <li>Payment system integrations.</li>
        <li>Development of new features.</li>
      </ul>
      <p class="sub-title">Tools</p>
      <ul>
        <li>JavaScript</li>
        <li>HTML/CSS</li>
        <li>Angular</li>
